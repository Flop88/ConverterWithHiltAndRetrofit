package ge.gergmoney.myconverterpro.di
...
import ge.gergmoney.myconverterpro.BuildConfig
import ge.gergmoney.myconverterpro.extension.EndPoints
import ge.gergmoney.myconverterpro.network.ApiService
...
class AppModule {
    ...
    @Provides
    @Singleton
    fun provideApiDatSource(apiService: ApiService) = DataSource(apiService)
}